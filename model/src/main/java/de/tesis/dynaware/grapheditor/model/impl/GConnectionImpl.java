 ...
 *   <li>{@link de.tesis.dynaware.grapheditor.model.impl.GConnectionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GConnectionImpl extends GConnectableImpl implements GConnection {
	 ...
	 * @ordered
	 */
	protected static final String SUBTYPE_EDEFAULT = "default";
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCONNECTION__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GraphPackage.GCONNECTION__SUBTYPE:
				return getSubtype();
			case GraphPackage.GCONNECTION__DESCRIPTION:

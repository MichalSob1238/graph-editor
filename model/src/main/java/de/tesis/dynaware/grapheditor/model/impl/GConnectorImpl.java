 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.GConnectorImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#getType <em>Type</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#getX <em>X</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#getY <em>Y</em>}</li>
 *   <li>{@link model.impl.GConnectorImpl#isConnectionDetachedOnDrag <em>Connection Detached On Drag</em>}</li>
 * </ul>
 *
 * @generated
 */

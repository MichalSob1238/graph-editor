 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.GModelImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link model.impl.GModelImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link model.impl.GModelImpl#getType <em>Type</em>}</li>
 *   <li>{@link model.impl.GModelImpl#getContentWidth <em>Content Width</em>}</li>
 *   <li>{@link model.impl.GModelImpl#getContentHeight <em>Content Height</em>}</li>
 *   <li>{@link model.impl.GModelImpl#getSupergraph <em>Supergraph</em>}</li>
 * </ul>
 *
 * @generated
 */

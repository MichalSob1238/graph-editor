...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	...
	public static GraphPackage init() {
		...
		GraphPackageImpl theModelPackage = registeredModelPackage instanceof GraphPackageImpl ? (GraphPackageImpl)registeredModelPackage : new GraphPackageImpl();
	 ...
	 */
	@Override
	public GraphFactory getModelFactory() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGNode_Description(), ecorePackage.getEString(), "description", "default", 0, 1, GNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

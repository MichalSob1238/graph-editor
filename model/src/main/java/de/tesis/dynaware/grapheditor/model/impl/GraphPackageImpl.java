...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	...
	public static GraphPackage init() {
		if (isInited) return (GraphPackage)EPackage.Registry.INSTANCE.getEPackage(eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(eNS_URI, theGraphPackage);
	 ...
	 */
	@Override
	public EAttribute getGConnection_Description() {
	...
	public void createPackageContents() {
		...
		createEAttribute(gConnectionEClass, GCONNECTION__DESCRIPTION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGConnection_Subtype(), ecorePackage.getEString(), "subtype", "default", 0, 1, GConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGConnection_Description(), ecorePackage.getEString(), "description", null, 0, 1, GConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

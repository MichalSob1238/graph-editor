...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected static GraphPackage graphPackage;
	...
	public ModelAdapterFactory() {
		if (graphPackage == null) {
			graphPackage = GraphPackage.eINSTANCE;
		}
	}
	...
	public boolean isFactoryForType(Object object) {
		if (object == graphPackage) {
			return true;
		}
		if (object instanceof EObject) {
			return ((EObject)object).eClass().getEPackage() == graphPackage;
		}
		return false;
	}
